...
Write PRD to `prd/{prd-name}/prd.md`
...
```bash
# Combined operation:
taskmaster parse-prd --input prd/{prd-name}/prd.md --research --num-tasks auto && \
...
📚 Documentation:
  - PRD: prd/{prd-name}/prd.md
  - Tasks: .taskmaster/tasks/
  - Progress: prd/{prd-name}/progress.md
